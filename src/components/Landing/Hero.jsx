...
//         {/* Announcement pill - Interview Sidekick style */}
...
//           <span className="text-xs font-bold text-primary-600 uppercase">New</span>
//           <span className="text-surface-700 text-sm font-medium">Introducing: AI Interview Copilot</span>
//           <svg className="w-4 h-4 text-surface-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
//           </svg>
//         </div>

//         {/* Headline - Sensei style: key phrase in blue */}
//         <h1 className="text-4xl sm:text-5xl md:text-display-xl font-bold text-surface-900 leading-tight mb-6 animate-fade-in-up">
//           AI Interview Assistant That{" "}
//           <span className="text-primary-500">Gets You Hired</span>
//         </h1>

//         {/* Sub-headline */}
//         <p className="text-lg md:text-xl text-surface-600 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up">
//           Activate your <strong className="text-surface-800">personal AI interview assistant</strong> for help{" "}
//           <strong className="text-surface-800">before, during, & after</strong> your job interview process.
//         </p>
...
//         {/* Social proof - avatar stack + "Join X Job Seekers" */}
//         <div className="flex items-center justify-center gap-3 mb-16 animate-fade-in-up">
//           <div className="flex -space-x-3">
//             {[1, 2, 3, 4].map((i) => (
//               <div
//                 key={i}
//                 className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-300 to-primary-500 border-2 border-white flex items-center justify-center text-white text-sm font-semibold"
//               >
...
//         {/* Product mockup - Interviewer / Sensei style two-panel card */}
//         <div className="relative max-w-4xl mx-auto animate-fade-in-up">
//           <div className="grid md:grid-cols-2 gap-4 md:gap-6">
//             <div className="rounded-2xl bg-white border border-surface-200 p-6 shadow-card-soft text-left">
//               <div className="flex items-center gap-2 mb-4">
//                 <div className="w-8 h-8 rounded-full bg-surface-200" />
//                 <span className="font-semibold text-surface-900">Interviewer</span>
//               </div>
//               <p className="text-surface-600 text-sm leading-relaxed">
//                 Tell me about a time when you explained a technical problem to someone who didn&apos;t have a tech background.
//               </p>
//               <div className="flex items-center gap-2 mt-4 text-primary-500 text-xs">
...
//                   </svg>
//                 </div>
//                 <span className="font-semibold text-surface-900">InterviewAI</span>
//               </div>
//               <div className="space-y-2 text-sm">
//                 <p className="font-medium text-surface-800">Situation:</p>
//                 <p className="text-surface-600">Building real-time analytics by integrating with third-party CRMs...</p>
//                 <p className="font-medium text-surface-800">Task:</p>
//                 <p className="text-surface-600">Explain to sales and marketing preparing for product launch.</p>
//                 <p className="font-medium text-surface-800">Action:</p>
//                 <p className="text-surface-600">Compared data sync process to postal service handling large volumes.</p>
//               </div>
//               <p className="text-primary-500 text-xs mt-3 font-medium">&lt;1 second latency</p>
//             </div>
//           </div>
//         </div>

//         {/* Stats - three cards like reference */}
//         <div className="grid grid-cols-3 gap-4 md:gap-6 max-w-3xl mx-auto mt-16 animate-fade-in-up">
//           {[
//             { value: "96%", label: "Interview Success Rate" },
//             { value: "10K+", label: "Interviews Aced" },
//             { value: "50K+", label: "Hours of Interview Help" },
//           ].map((stat, i) => (
//             <div key={i} className="rounded-2xl bg-white border border-surface-100 p-6 shadow-card-soft hover:shadow-card-hover transition-shadow">
//               <div className="text-2xl md:text-3xl font-bold text-primary-500">{stat.value}</div>
//               <div className="text-surface-500 text-sm mt-1">{stat.label}</div>
//             </div>
//           ))}
//         </div>
//       </div>
...
//       <div className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
...
//         {/* Sub-headline */}
//         <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed animate-fade-in">
...
//               <div
//                 key={i}
//                 className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 border-2 border-white flex items-center justify-center text-white text-xs font-semibold shadow-md"
//               >
//                 {String.fromCharCode(64 + i)}
//               </div>
//             ))}
...
//           <button
//             onClick={() => navigate("/interview")}
//             className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-xl"
//           >
//             Try for free
//           </button>
//         </div>

//         {/* Product mockup - 3D perspective */}
//         <div className="relative max-w-4xl mx-auto animate-fade-in" style={{ perspective: "1000px" }}>
//           <div className="grid md:grid-cols-2 gap-6 md:gap-8" style={{ transformStyle: "preserve-3d" }}>
//             {/* Left Card - Interviewer */}
//             <div
//               className="relative rounded-2xl bg-white border border-gray-200 p-6 text-left transition-all duration-500 hover:shadow-2xl"
//               style={{
...
//               <div className="absolute -left-4 bottom-20 flex items-center gap-2 bg-white rounded-full px-3 py-1.5 shadow-lg border border-gray-100 text-xs font-medium text-gray-700">
...
//               <svg className="absolute -left-8 bottom-32 w-12 h-12 text-gray-400" viewBox="0 0 50 50" fill="none">
//                 <path d="M40 10 C 30 15, 15 20, 10 40" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
//                 <path d="M8 35 L10 42 L17 38" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
//               </svg>
...
//                 </div>
//                 <span className="font-semibold text-blue-600">Interviewer</span>
//               </div>
//               <p className="text-gray-600 text-sm leading-relaxed">
//                 Tell me about a time when you explained a technical problem to someone who didn't have a tech background.
//               </p>
//               <div className="flex items-center gap-2 mt-6 text-blue-500 text-xs">
//                 <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
//                 listening to interviewer...
//               </div>
//             </div>

//             {/* Right Card - Sensei/AI */}
//             <div
//               className="relative rounded-2xl bg-white border border-gray-200 p-6 text-left transition-all duration-500 hover:shadow-2xl"
//               style={{
//                 transform: "rotateY(-5deg) rotateX(2deg)",
...
//               }}
//             >
//               {/* Personalized answer badge */}
//               <div className="absolute -right-4 top-4 bg-white rounded-full px-3 py-1.5 shadow-lg border border-gray-100 text-xs font-medium text-gray-700">
//                 Personalized answer
//               </div>

//               {/* Latency badge with arrow */}
...
//                   <path d="M5 20 C 15 18, 25 22, 30 15" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
//                 </svg>
//                 <div className="bg-white rounded-full px-3 py-1.5 shadow-lg border border-gray-100 text-xs font-medium text-gray-700">
//                   &lt;1 second latency
//                 </div>
//               </div>
...
//                     - Building real-time analytics by integrating with third-party CRM systems.<br/>
//                     - Significant latency for the data synchronization process between our platform and the CRM systems<br/>
//                     - The way our platform handled API rate limits and managed concurrent data requests is incorrect
//                   </p>
//                 </div>
//                 <div>
//                   <p className="font-semibold text-gray-900">Task:</p>
//                   <p className="text-gray-600 text-xs leading-relaxed">
//                     - Explain to sales and marketing, who were preparing for a product launch.
//                   </p>
//                 </div>
//                 <div>
//                   <p className="font-semibold text-gray-900">Action:</p>
//                   <p className="text-gray-600 text-xs leading-relaxed">
//                     - Compare data synchronisation process to a postal service handling large volumes of mail.<br/>
//                     - The issue was like having too many packages
//                   </p>
//                 </div>
//               </div>
//             </div>
