...
//     description: "Input your resume, personal stories, and job information for personalized responses.",
//   },
//   {
//     num: 2,
//     title: "Try AI in Our Playground",
//     description: "Experiment with our AI in a sandbox environment to understand its capabilities.",
//   },
//   {
//     num: 3,
//     title: "Configure Settings",
//     description: "Fine-tune parameters to customize the tone and style of your responses.",
//   },
//   {
//     num: 4,
//     title: "Sit Back and Interview",
//     description: "Let InterviewAI handle the hard work to help you have a confident interview and land the job.",
//   },
// ];
...
//         <h2 className="text-4xl md:text-5xl font-bold text-surface-900 text-center mb-16">
//           How does InterviewAI work?
//         </h2>

//         <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
//           {STEPS.map((step) => (
//             <div key={step.num} className="text-center">
//               <div className="w-14 h-14 rounded-full border-2 border-primary-500 bg-white flex items-center justify-center mx-auto mb-6 text-primary-600 font-bold text-xl">
//                 {step.num}
//               </div>
...
//           <button onClick={() => navigate("/interview")} className="btn-dark px-8 py-4 text-lg">
...
// const AI_ANSWER = `Situation: Our platform needed real-time analytics integration with a CRM system. The marketing team was confused by technical jargon about API rate limits and data synchronization delays.
// Task: Explain clearly to non-technical stakeholders so they understand the problem.
// Action: I compared data synchronization to a postal service handling many packages at once, highlighting bottlenecks and solutions.
// Result: The team understood the process and could make informed decisions without technical confusion.`;
...
//     const typeAnimation = () => {
//       i = 0;
//       setTypedText(""); // clear before typing
//       const interval = setInterval(() => {
//         setTypedText(AI_ANSWER.slice(0, i + 1));
//         i++;
//         if (i === AI_ANSWER.length) {
//           clearInterval(interval);
//           setTimeout(typeAnimation, 2000); // wait 2s, then restart
//         }
//       }, 30); // typing speed
//     };

//     typeAnimation(); // start infinite typing

//     return () => {}; // no cleanup needed as setTimeout clears old intervals
//   }, []);

//   return (
//     <section className="py-24 md:py-32 bg-gradient-to-b from-surface-50 to-surface-100">
//       <div className="max-w-6xl mx-auto px-6 lg:px-8">
//         {/* Heading */}
//         <h2 className="text-4xl md:text-5xl font-bold text-surface-900 text-center mb-16 drop-shadow-lg">
//           How does InterviewAI work?
//         </h2>
...
//             <div
//               key={step.num}
//               className="text-center bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300"
//             >
//               <div className="w-14 h-14 rounded-full border-2 border-primary-500 bg-gradient-to-br from-white to-surface-100 flex items-center justify-center mx-auto mb-6 text-primary-600 font-bold text-xl shadow-md">
//                 {step.num}
//               </div>
//               <h3 className="text-xl font-semibold text-surface-900 mb-3">{step.title}</h3>
//               <p className="text-surface-600 text-sm leading-relaxed">{step.description}</p>
...
//             className="btn-dark px-8 py-4 text-lg hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl"
//           >
//             Try interactive demo ↓
//           </button>
//         </div>
...
//         <div className="grid md:grid-cols-2 gap-8 bg-white rounded-2xl shadow-2xl p-8 transform hover:-translate-y-1 transition-all duration-300">
//           {/* Interviewer Panel */}
//           <div className="border border-surface-200 rounded-lg p-6 shadow-inner">
//             <h3 className="text-lg font-semibold text-surface-900 mb-4">Interviewer</h3>
...
//             </p>
//             <span className="text-sm text-primary-600 font-medium">Listening to interviewer...</span>
//           </div>

//           {/* AI Panel with typing animation */}
//           <div className="border border-surface-200 rounded-lg p-6 shadow-inner bg-gradient-to-br from-surface-50 to-white min-h-[200px]">
//             <h3 className="text-lg font-semibold text-surface-900 mb-4">InterviewAI</h3>
//             <pre className="whitespace-pre-wrap text-surface-700 text-sm leading-relaxed font-mono min-h-[140px]">
//               {typedText}
