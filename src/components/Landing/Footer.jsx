        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <button onClick={() => navigate("/privacy-policy")} className="text-slate-400 hover:text-white transition-colors inline-flex items-center group">
                  <span className="w-1.5 h-1.5 bg-indigo-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Privacy Policy
                </button>
              </li>
              <li>
                <a href="Termsandservice" className="text-slate-400 hover:text-white transition-colors inline-flex items-center group">
                  <span className="w-1.5 h-1.5 bg-indigo-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Terms of Service
                </a>
              </li>
