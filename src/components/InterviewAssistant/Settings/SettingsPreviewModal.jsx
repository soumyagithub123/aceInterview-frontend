...
export default function SettingsModal({ settings, backendUrl, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-3 sm:px-4">
      ...
      <div className="relative w-full max-w-3xl max-h-[90vh] overflow-hidden rounded-3xl border border-white/10 bg-[#0b0b10] shadow-[0_40px_140px_-60px_rgba(0,0,0,0.85)]">
        {/* Top glow */}
        <div className="pointer-events-none absolute -top-24 left-1/2 h-40 sm:h-48 w-[36rem] sm:w-[44rem] -translate-x-1/2 rounded-full bg-gradient-to-r from-purple-500/30 via-fuchsia-500/20 to-cyan-500/20 blur-3xl" />

        {/* Header */}
        <div className="relative flex flex-wrap items-center justify-between gap-3 px-4 sm:px-6 py-4 sm:py-5 border-b border-white/10 bg-[#0b0b10]/85 backdrop-blur-xl">
          <div className="flex items-center gap-3 min-w-0">
            <div className="relative shrink-0">
              ...
              <div className="relative h-10 sm:h-11 w-10 sm:w-11 rounded-2xl border border-white/10 bg-white/5 flex items-center justify-center">
                <SettingsIcon className="h-4 sm:h-5 w-4 sm:w-5 text-purple-200" />
              </div>
            </div>
        ...
        {/* Content */}
        <div className="relative overflow-y-auto max-h-[calc(90vh-140px)] px-4 sm:px-6 py-4 sm:py-5">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
            {/* Configuration */}
            <section className="lg:col-span-3">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-4 space-y-3">
                {rows.map(({ label, value, icon: Icon }) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="h-9 sm:h-10 w-9 sm:w-10 rounded-2xl border border-white/10 bg-black/20 flex items-center justify-center shrink-0">
                        <Icon className="h-4 sm:h-5 w-4 sm:w-5 text-zinc-200" />
                      </div>
            ...
            {/* Optimization */}
            <section className="lg:col-span-2">
              <div className="rounded-3xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/10 via-white/[0.04] to-white/[0.03] p-4 sm:p-5 shadow-[0_18px_80px_-55px_rgba(16,185,129,0.35)]">
                <div className="flex items-start gap-3">
                  <div className="h-10 sm:h-11 w-10 sm:w-11 rounded-2xl border border-emerald-500/25 bg-emerald-500/10 flex items-center justify-center shrink-0">
                    <ShieldCheck className="h-4 sm:h-5 w-4 sm:w-5 text-emerald-200" />
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-sm font-semibold text-emerald-200">
                      Reliability safeguards
              ...
              <p className="mt-3 sm:mt-4 text-[11px] text-zinc-500">
                Tip: If audio/transcription stalls, these mechanisms handle
        ...
        {/* Footer */}
        <div className="relative border-t border-white/10 bg-[#0b0b10]/85 backdrop-blur-xl px-4 sm:px-6 py-4">
          <button
            onClick={onClose}
            className="w-full rounded-2xl border border-purple-300/15 bg-gradient-to-b from-purple-500 to-fuchsia-500 hover:brightness-[1.02] active:brightness-[0.98] text-white font-semibold py-3 shadow-[0_20px_70px_-45px_rgba(168,85,247,0.6)] transition"
          >
